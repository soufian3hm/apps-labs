...
export default function NewProductPage() {
    ...
    const [formSubtitle, setFormSubtitle] = useState('Fill in your details');
    ...
    const loadStoreData = async () => {
        ...
        const { data } = await supabase
            .from('stores')
            .select('id, name, currency_symbol, currency_position, custom_domain')
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (productData) {
                await supabase.from('lead_form_configs').insert({
                    product_id: productData.id,
                    title: formTitle,
                                ...
                                <CardContent className="p-6 pt-0 space-y-4">
                                    ...
                                    {hasVariants && (
                                        <div className="space-y-4">
                                            ...
                                            <Button variant="outline" onClick={handleAddVariant} className="w-full">
