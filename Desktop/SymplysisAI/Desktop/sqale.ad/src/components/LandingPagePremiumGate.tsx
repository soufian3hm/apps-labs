...
import { Zap, ArrowRight, Layout, Eye, Download, Sparkles } from 'lucide-react'

const LandingPagePremiumGate: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-[#F3F4F6] overflow-hidden relative">
      {/* Mesh Gradient Background - Green/Emerald theme */}
      <div 
        ...
        style={{
          background: `
            ...
            radial-gradient(at 0% 100%, rgba(132, 204, 22, 0.15) 0px, transparent 50%)
          `,
          filter: 'blur(40px)',
      ...
      <div className="relative w-full max-w-6xl h-[650px] mx-4 md:mx-8 bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl shadow-emerald-500/10 ring-1 ring-white/60 border border-white overflow-hidden flex flex-col lg:flex-row z-10">
        ...
        <div className="lg:w-2/5 p-8 lg:p-12 flex flex-col justify-between bg-white/40 relative overflow-hidden group">
          {/* Decoration Circle */}
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-emerald-50 rounded-full blur-3xl opacity-50 group-hover:scale-110 transition-transform duration-700"></div>
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-gray-950 mb-4 leading-[1.1]">
              Unlock <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">Landing Page</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed font-medium">
              Build high-converting landing pages in minutes. Use drag-and-drop components, AI content rewriting, and instant export options.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full content-center">
            ...
            <div className="col-span-1 sm:col-span-2 group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              ...
              <div className="mt-6 flex items-baseline gap-1">
                ...
                <span className="text-lg font-medium text-gray-500">pages/mo</span>
              </div>
              {/* Visual Progress Bar */}
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              ...
              <div className="bg-emerald-50 p-3 rounded-2xl text-emerald-600 w-fit mb-4 relative z-10">
                <Layout className="w-6 h-6" />
              </div>
              <h3 className="font-semibold text-gray-900 relative z-10">Drag & Drop</h3>
              <p className="text-sm text-gray-500 mt-1 relative z-10">Intuitively build pages with pre-made components.</p>
            </div>

            {/* Item 3: AI Rewriting (Dark Card) */}
            <div className="group relative overflow-hidden rounded-3xl bg-gray-900 p-6 text-white transition-all hover:shadow-xl hover:scale-[1.02]">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 to-teal-700 opacity-20"></div>
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  ...
                  <h3 className="font-semibold text-white text-lg">AI Rewriting</h3>
                  <p className="text-sm text-emerald-100 mt-1">Instant content polish</p>
                </div>
                {/* Animated elements */}
                <div className="mt-4 flex gap-1.5">
                  <div className="h-1.5 w-6 rounded-full bg-emerald-400/60 animate-pulse"></div>
                  <div className="h-1.5 w-4 rounded-full bg-emerald-400/40 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                  <div className="h-1.5 w-8 rounded-full bg-emerald-400/80 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                </div>
              </div>
            </div>
            ...
            {/* Item 4: Live Preview */}
            <div className="group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              <div className="bg-teal-50 p-3 rounded-2xl text-teal-600 w-fit mb-4">
                <Eye className="w-6 h-6" />
              </div>
              <h3 className="font-semibold text-gray-900">Live Preview</h3>
              <p className="text-sm text-gray-500 mt-1">See changes in real-time as you edit.</p>
            </div>

            {/* Item 5: Export Options */}
            <div className="group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              <div className="bg-lime-50 p-3 rounded-2xl text-lime-600 w-fit mb-4">
                <Download className="w-6 h-6" />
              </div>
              <h3 className="font-semibold text-gray-900">Export Options</h3>
              <p className="text-sm text-gray-500 mt-1">Download code or publish directly.</p>
            </div>
...
export default LandingPagePremiumGate
