...
const VoiceoverPremiumGate: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-[#F3F4F6] overflow-hidden relative">
      {/* Mesh Gradient Background - Purple/Violet Theme */}
      <div 
      ...
      <div className="relative w-full max-w-6xl h-[650px] mx-4 md:mx-8 bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl shadow-purple-500/10 ring-1 ring-white/60 border border-white overflow-hidden flex flex-col lg:flex-row z-10">
        ...
        <div className="lg:w-2/5 p-8 lg:p-12 flex flex-col justify-between bg-white/40 relative overflow-hidden group">
          {/* Decoration Circle */}
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-purple-50 rounded-full blur-3xl opacity-50 group-hover:scale-110 transition-transform duration-700"></div>
          
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-purple-700 text-xs font-semibold tracking-wide uppercase mb-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-gray-950 mb-4 leading-[1.1]">
              Unlock <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-violet-600">Voiceover</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed font-medium">
              Transform text into lifelike speech. Access our neural audio engine and accelerate your content creation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full content-center">
            ...
            <div className="col-span-1 sm:col-span-2 group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              ...
              <div className="mt-4 h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full w-3/4 bg-gradient-to-r from-purple-400 to-violet-500 rounded-full"></div>
              </div>
            </div>

            {/* Item 2: Global Voices (Span 1) */}
            <div className="group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10">
              ...
              <h3 className="font-semibold text-gray-900 relative z-10">Global Voices</h3>
              <p className="text-sm text-gray-500 mt-1 mb-4 relative z-10">30+ Languages & Accents</p>
              
              {/* Avatar Stack Visual */}
              <div className="flex -space-x-3 relative z-10 mt-auto">
                <img className="w-10 h-10 rounded-full border-2 border-white" src="https://i.pravatar.cc/100?img=1" alt="Avatar 1" />
                <img className="w-10 h-10 rounded-full border-2 border-white" src="https://i.pravatar.cc/100?img=5" alt="Avatar 2" />
                <img className="w-10 h-10 rounded-full border-2 border-white" src="https://i.pravatar.cc/100?img=9" alt="Avatar 3" />
                <div className="w-10 h-10 rounded-full border-2 border-white bg-purple-50 flex items-center justify-center text-xs font-bold text-purple-600">+27</div>
              </div>
            </div>

            {/* Item 3: AI Writer (Dark Card, Span 1) */}
            <div className="group relative overflow-hidden rounded-3xl bg-gray-900 p-6 text-white transition-all hover:shadow-xl hover:scale-[1.02]">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-violet-700 opacity-20"></div>
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  ...
                  <h3 className="font-semibold text-white text-lg">AI Writer</h3>
                  <p className="text-sm text-purple-100 mt-1">Auto-generate scripts</p>
                </div>
                {/* Animated elements */}
                <div className="mt-4 flex gap-1">
                  <div className="h-1.5 w-1.5 rounded-full bg-purple-400 animate-bounce"></div>
                  <div className="h-1.5 w-1.5 rounded-full bg-purple-400 animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                  <div className="h-1.5 w-1.5 rounded-full bg-purple-400 animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                </div>
              </div>
            </div>

            {/* Item 4: Custom Script TTS (Span 2) */}
            <div className="col-span-1 sm:col-span-2 group relative overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-gray-900/5 transition-all hover:shadow-md hover:ring-gray-900/10 flex items-center gap-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Custom Script TTS</h3>
                <p className="text-sm text-gray-500 mt-1">Paste your own text directly. No character limits.</p>
              </div>
            </div>
...
export default VoiceoverPremiumGate
